...
// score_t one_up[] = {{C4, EIGHTH_NOTE, 0}, {G3, EIGHTH_NOTE, 0}, {C4, EIGHTH_NOTE, 0}, {E4, EIGHTH_NOTE, 0}, {G4, EIGHTH_NOTE, 0}, {C5, EIGHTH_NOTE, 0}, {G4, EIGHTH_NOTE, 0}, {Gs4, EIGHTH_NOTE, 0}, {C4, EIGHTH_NOTE, 0}, {Ds4, EIGHTH_NOTE, 0}, {Gs4, EIGHTH_NOTE, 0}, {Ds4, EIGHTH_NOTE, 0}, {Gs4, EIGHTH_NOTE, 0}, {C5, EIGHTH_NOTE, 0}, {Ds5, EIGHTH_NOTE, 0}, {Gs5, EIGHTH_NOTE, 0}, {Ds5, EIGHTH_NOTE, 0}, {As3, EIGHTH_NOTE, 0}, {D4, EIGHTH_NOTE, 0}, {F4, EIGHTH_NOTE, 0}, {As4, EIGHTH_NOTE, 0}, {D4, EIGHTH_NOTE, 0}, {As4, EIGHTH_NOTE, 0}, {D5, EIGHTH_NOTE, 0}, {F5, EIGHTH_NOTE, 0}, {As5, EIGHTH_NOTE, 0}, {F5, EIGHTH_NOTE, 0}};
// score_t tetris[] = {{Cs5, QUARTER_NOTE, 0}, {Gs4, EIGHTH_NOTE, 0}, {A4, EIGHTH_NOTE, 0}, {B4, QUARTER_NOTE, 0}, {A4, EIGHTH_NOTE, 0}, {Gs4, EIGHTH_NOTE, 0}, {Fs4, QUARTER_NOTE - 10, 10}, {Fs4, EIGHTH_NOTE, 0}, {A4, EIGHTH_NOTE, 0}, {Cs5, QUARTER_NOTE, 0}, {B4, EIGHTH_NOTE, 0}, {A4, EIGHTH_NOTE, 0}, {Gs4, QUARTER_NOTE - 10, 10}, {Gs4, EIGHTH_NOTE, 0}, {A4, EIGHTH_NOTE, 0}, {B4, QUARTER_NOTE, 0}, {Cs5, QUARTER_NOTE, 0}, {A4, QUARTER_NOTE, 0}, {Fs4, QUARTER_NOTE - 10, 10}, {Fs4, QUARTER_NOTE, QUARTER_NOTE + EIGHTH_NOTE}, {B4, QUARTER_NOTE, 0}, {D5, EIGHTH_NOTE, 0}, {Fs5, QUARTER_NOTE, 0}, {E5, EIGHTH_NOTE, 0}, {D5, EIGHTH_NOTE, 0}, {Cs5, QUARTER_NOTE, EIGHTH_NOTE}, {A4, EIGHTH_NOTE, 0}, {Cs5, QUARTER_NOTE, 0}, {B4, EIGHTH_NOTE, 0}, {A4, EIGHTH_NOTE, 0}, {Gs4, QUARTER_NOTE - 10, 10}, {Gs4, EIGHTH_NOTE, 0}, {A4, EIGHTH_NOTE, 0}, {B4, QUARTER_NOTE, 0}, {Cs5, QUARTER_NOTE, 0}, {A4, QUARTER_NOTE, 0}, {Fs4, QUARTER_NOTE - 10, 10}, {Fs4, QUARTER_NOTE, QUARTER_NOTE}};
...
void esp_now_callback(const esp_now_recv_info *esp_now_recieve_info, const unsigned char *recieve_data, int length) {
  ...
  if(strncmp(recieve_data_buffer, "HELLO\0", 6) == 0) {
    ...
    // music.play(tetris, (sizeof(tetris) / sizeof(score_t)), 160);
